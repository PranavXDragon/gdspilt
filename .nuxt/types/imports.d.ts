...
export {}
declare global {
  const EXPENSE_CATEGORIES: typeof import('../../utils/constants').EXPENSE_CATEGORIES
  ...
  const addMemberToGroup: typeof import('../../utils/db.client').addMemberToGroup
  const addRouteMiddleware: typeof import('../../node_modules/nuxt/dist/app/composables/router').addRouteMiddleware
  const addTransactionToGroup: typeof import('../../utils/db.client').addTransactionToGroup
  const applyChangesForGroup: typeof import('../../utils/db.client').applyChangesForGroup
  const buildMemberIdToName: typeof import('../../utils/supabase.client').buildMemberIdToName
  const buildMemberNameToId: typeof import('../../utils/supabase.client').buildMemberNameToId
  const callOnce: typeof import('../../node_modules/nuxt/dist/app/composables/once').callOnce
  const cancelIdleCallback: typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback').cancelIdleCallback
  const checkChange: typeof import('../../utils/db.client').checkChange
  ...
  const computeTransaction: typeof import('../../composables/useGroups.client').computeTransaction
  const computed: typeof import('vue').computed
  const createEmptyGroup: typeof import('../../utils/db.client').createEmptyGroup
  const createError: typeof import('../../node_modules/nuxt/dist/app/composables/error').createError
  const createGroup: typeof import('../../utils/db.client').createGroup
  const createPopper: typeof import('../../node_modules/@nuxt/ui/dist/runtime/composables/usePopper').createPopper
  const customRef: typeof import('vue').customRef
  const dbInit: typeof import('../../utils/db.client').dbInit
  ...
  const deleteMemberFromGroup: typeof import('../../utils/db.client').deleteMemberFromGroup
  const deleteTransactionFromGroup: typeof import('../../utils/db.client').deleteTransactionFromGroup
  const effect: typeof import('vue').effect
  const effectScope: typeof import('vue').effectScope
  const getActivity: typeof import('../../utils/db.client').getActivity
  const getActivityById: typeof import('../../utils/db.client').getActivityById
  const getAppManifest: typeof import('../../node_modules/nuxt/dist/app/composables/manifest').getAppManifest
  const getColorForValue: typeof import('../../utils/get-color-for-value').getColorForValue
  const getCurrentInstance: typeof import('vue').getCurrentInstance
  const getCurrentScope: typeof import('vue').getCurrentScope
  const getGroup: typeof import('../../utils/db.client').getGroup
  const getGroupChanges: typeof import('../../utils/db.client').getGroupChanges
  const getGroupDB: typeof import('../../utils/db.client').getGroupDB
  const getGroups: typeof import('../../utils/db.client').getGroups
  const getRouteRules: typeof import('../../node_modules/nuxt/dist/app/composables/manifest').getRouteRules
  const getSiteID: typeof import('../../utils/db.client').getSiteID
  const getSupabase: typeof import('../../utils/supabase.client').getSupabase
  const groupGetBalances: typeof import('../../composables/useGroups.client').groupGetBalances
  const groupGetMyBalance: typeof import('../../composables/useGroups.client').groupGetMyBalance
  const groupGetPayments: typeof import('../../composables/useGroups.client').groupGetPayments
  const h: typeof import('vue').h
  const hasInjectionContext: typeof import('vue').hasInjectionContext
  const importSplitwise: typeof import('../../utils/db.client').importSplitwise
  const importSupabase: typeof import('../../utils/db.client').importSupabase
  const initGroupDb: typeof import('../../utils/db.client').initGroupDb
  const inject: typeof import('vue').inject
  const injectHead: typeof import('../../node_modules/nuxt/dist/app/composables/head').injectHead
  const insertChange: typeof import('../../utils/db.client').insertChange
  ...
  const round: typeof import('../../composables/useGroups.client').round
  const setGroupCurrency: typeof import('../../utils/db.client').setGroupCurrency
  const setGroupName: typeof import('../../utils/db.client').setGroupName
  const setInterval: typeof import('../../node_modules/nuxt/dist/app/compat/interval').setInterval
  const setName: typeof import('../../composables/useName').setName
  ...
  const splitTypes: typeof import('../../utils/constants').splitTypes
  const storeToRefs: typeof import('../../node_modules/@pinia/nuxt/dist/runtime/composables').storeToRefs
  const toRaw: typeof import('vue').toRaw
  const toRef: typeof import('vue').toRef
  const toRefs: typeof import('vue').toRefs
  const toTitleCase: typeof import('../../utils/title-case').toTitleCase
  const toValue: typeof import('vue').toValue
  const triggerRef: typeof import('vue').triggerRef
  const tryUseNuxtApp: typeof import('../../node_modules/nuxt/dist/app/nuxt').tryUseNuxtApp
  const unref: typeof import('vue').unref
  const updateAppConfig: typeof import('../../node_modules/nuxt/dist/app/config').updateAppConfig
  const updateGroup: typeof import('../../utils/db.client').updateGroup
  const updateGroups: typeof import('../../composables/useGroups.client').updateGroups
  const updateMemberInGroup: typeof import('../../utils/db.client').updateMemberInGroup
  const updateTransactionInGroup: typeof import('../../utils/db.client').updateTransactionInGroup
  ...
  const useGroupID: typeof import('../../composables/useGroups.client').useGroupID
  const useGroups: typeof import('../../composables/useGroups.client').useGroups
  ...
  const useName: typeof import('../../composables/useName').useName
  ...
  const wipeData: typeof import('../../utils/db.client').wipeData
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly EXPENSE_CATEGORIES: UnwrapRef<typeof import('../../utils/constants')['EXPENSE_CATEGORIES']>
    ...
    readonly addMemberToGroup: UnwrapRef<typeof import('../../utils/db.client')['addMemberToGroup']>
    readonly addRouteMiddleware: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/router')['addRouteMiddleware']>
    readonly addTransactionToGroup: UnwrapRef<typeof import('../../utils/db.client')['addTransactionToGroup']>
    readonly applyChangesForGroup: UnwrapRef<typeof import('../../utils/db.client')['applyChangesForGroup']>
    readonly buildMemberIdToName: UnwrapRef<typeof import('../../utils/supabase.client')['buildMemberIdToName']>
    readonly buildMemberNameToId: UnwrapRef<typeof import('../../utils/supabase.client')['buildMemberNameToId']>
    readonly callOnce: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/once')['callOnce']>
    readonly cancelIdleCallback: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/compat/idle-callback')['cancelIdleCallback']>
    readonly checkChange: UnwrapRef<typeof import('../../utils/db.client')['checkChange']>
    ...
    readonly computeTransaction: UnwrapRef<typeof import('../../composables/useGroups.client')['computeTransaction']>
    readonly computed: UnwrapRef<typeof import('vue')['computed']>
    readonly createEmptyGroup: UnwrapRef<typeof import('../../utils/db.client')['createEmptyGroup']>
    readonly createError: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/error')['createError']>
    readonly createGroup: UnwrapRef<typeof import('../../utils/db.client')['createGroup']>
    ...
    readonly dbInit: UnwrapRef<typeof import('../../utils/db.client')['dbInit']>
    ...
    readonly deleteMemberFromGroup: UnwrapRef<typeof import('../../utils/db.client')['deleteMemberFromGroup']>
    readonly deleteTransactionFromGroup: UnwrapRef<typeof import('../../utils/db.client')['deleteTransactionFromGroup']>
    readonly effect: UnwrapRef<typeof import('vue')['effect']>
    readonly effectScope: UnwrapRef<typeof import('vue')['effectScope']>
    readonly getActivity: UnwrapRef<typeof import('../../utils/db.client')['getActivity']>
    readonly getActivityById: UnwrapRef<typeof import('../../utils/db.client')['getActivityById']>
    readonly getAppManifest: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/manifest')['getAppManifest']>
    readonly getColorForValue: UnwrapRef<typeof import('../../utils/get-color-for-value')['getColorForValue']>
    readonly getCurrentInstance: UnwrapRef<typeof import('vue')['getCurrentInstance']>
    readonly getCurrentScope: UnwrapRef<typeof import('vue')['getCurrentScope']>
    readonly getGroup: UnwrapRef<typeof import('../../utils/db.client')['getGroup']>
    readonly getGroupChanges: UnwrapRef<typeof import('../../utils/db.client')['getGroupChanges']>
    readonly getGroupDB: UnwrapRef<typeof import('../../utils/db.client')['getGroupDB']>
    readonly getGroups: UnwrapRef<typeof import('../../utils/db.client')['getGroups']>
    readonly getRouteRules: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/manifest')['getRouteRules']>
    readonly getSiteID: UnwrapRef<typeof import('../../utils/db.client')['getSiteID']>
    readonly getSupabase: UnwrapRef<typeof import('../../utils/supabase.client')['getSupabase']>
    readonly groupGetBalances: UnwrapRef<typeof import('../../composables/useGroups.client')['groupGetBalances']>
    readonly groupGetMyBalance: UnwrapRef<typeof import('../../composables/useGroups.client')['groupGetMyBalance']>
    readonly groupGetPayments: UnwrapRef<typeof import('../../composables/useGroups.client')['groupGetPayments']>
    readonly h: UnwrapRef<typeof import('vue')['h']>
    readonly hasInjectionContext: UnwrapRef<typeof import('vue')['hasInjectionContext']>
    readonly importSplitwise: UnwrapRef<typeof import('../../utils/db.client')['importSplitwise']>
    readonly importSupabase: UnwrapRef<typeof import('../../utils/db.client')['importSupabase']>
    readonly initGroupDb: UnwrapRef<typeof import('../../utils/db.client')['initGroupDb']>
    readonly inject: UnwrapRef<typeof import('vue')['inject']>
    readonly injectHead: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/head')['injectHead']>
    readonly insertChange: UnwrapRef<typeof import('../../utils/db.client')['insertChange']>
    ...
    readonly round: UnwrapRef<typeof import('../../composables/useGroups.client')['round']>
    readonly setGroupCurrency: UnwrapRef<typeof import('../../utils/db.client')['setGroupCurrency']>
    readonly setGroupName: UnwrapRef<typeof import('../../utils/db.client')['setGroupName']>
    readonly setInterval: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/compat/interval')['setInterval']>
    readonly setName: UnwrapRef<typeof import('../../composables/useName')['setName']>
    ...
    readonly splitTypes: UnwrapRef<typeof import('../../utils/constants')['splitTypes']>
    ...
    readonly toTitleCase: UnwrapRef<typeof import('../../utils/title-case')['toTitleCase']>
    readonly toValue: UnwrapRef<typeof import('vue')['toValue']>
    readonly triggerRef: UnwrapRef<typeof import('vue')['triggerRef']>
    readonly tryUseNuxtApp: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/nuxt')['tryUseNuxtApp']>
    readonly unref: UnwrapRef<typeof import('vue')['unref']>
    readonly updateAppConfig: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/config')['updateAppConfig']>
    readonly updateGroup: UnwrapRef<typeof import('../../utils/db.client')['updateGroup']>
    readonly updateGroups: UnwrapRef<typeof import('../../composables/useGroups.client')['updateGroups']>
    readonly updateMemberInGroup: UnwrapRef<typeof import('../../utils/db.client')['updateMemberInGroup']>
    readonly updateTransactionInGroup: UnwrapRef<typeof import('../../utils/db.client')['updateTransactionInGroup']>
    ...
    readonly useGroupID: UnwrapRef<typeof import('../../composables/useGroups.client')['useGroupID']>
    readonly useGroups: UnwrapRef<typeof import('../../composables/useGroups.client')['useGroups']>
    ...
    readonly useName: UnwrapRef<typeof import('../../composables/useName')['useName']>
    ...
    readonly wipeData: UnwrapRef<typeof import('../../utils/db.client')['wipeData']>
