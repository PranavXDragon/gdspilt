...
import { _ as __nuxt_component_7, a as __nuxt_component_1$1, b as __nuxt_component_0$1, c as __nuxt_component_4, d as __nuxt_component_2$1 } from "./Modal-CpCVwxs4.js";
import { _ as __nuxt_component_2 } from "./Accordion-9U6bskbT.js";
import { _ as __nuxt_component_0 } from "./Button-CIOzeTUV.js";
import { _ as _sfc_main$3, a as _sfc_main$6 } from "./PaymentEditor-Bpw8D6nD.js";
import { _ as _sfc_main$4, a as __nuxt_component_7$1, E as EXPENSE_CATEGORIES, b as _sfc_main$5, c as _sfc_main$7, d as _sfc_main$8 } from "./GroupSettings-Bs8Sbqhi.js";
import { s as storeToRefs, b as useGroups, n as navigateTo, c as __nuxt_component_8, d as __nuxt_component_9, r as round, e as useName, f as createEmptyGroup, g as updateGroup } from "../server.mjs";
import { computed, mergeProps, withCtx, unref, createTextVNode, createVNode, openBlock, createBlock, toDisplayString, Fragment, renderList, createCommentVNode, withModifiers, useSSRContext, ref, watch, isRef, nextTick } from "vue";
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttrs } from "vue/server-renderer";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SpinLoader = _sfc_main$3;
      const _component_UButton = __nuxt_component_0;
      const _component_UAlert = __nuxt_component_2;
      const _component_YourBalances = _sfc_main$4;
      ...
      const _component_ExpenseGroup = _sfc_main$5;
      const _component_UModal = __nuxt_component_4;
      const _component_PaymentEditor = _sfc_main$6;
      ...
      const _component_GroupSettings = _sfc_main$8;
      const _component_UCard = __nuxt_component_7;
      _push(`<!--[-->`);
      if (unref(loading)) {
      ...
      if (!unref(loading) && unref(group)) {
        _push(`<div class="flex flex-col gap-3 h-full px-3"><div class="h-14 flex items-center gap-1"><span class="font-semibold text-lg truncate">${ssrInterpolate(unref(getGroupByID)(unref(groupID))?.name)}</span><div class="flex gap-0.5 ml-auto">`);
        ...
        _push(ssrRenderComponent(_component_USelectMenu, {
          ...
          label: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span${_scopeId}>${ssrInterpolate(sortOptions.find((o) => o.id === unref(sortBy))?.label || "Sort")}</span></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-center gap-1.5 text-xs" }, [
                  ...
                  createVNode("span", null, toDisplayString(sortOptions.find((o) => o.id === unref(sortBy))?.label || "Sort"), 1)
                ])
              ];
            }
          }),
...
//# sourceMappingURL=groups-BcuuHjBR.js.map
