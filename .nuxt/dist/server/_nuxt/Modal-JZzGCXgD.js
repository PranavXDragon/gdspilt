import { ref, computed, watchEffect, defineComponent, inject, nextTick, watch, provide, h as h$1, Fragment, toRaw, reactive, cloneVNode, shallowRef, unref, getCurrentInstance, Teleport, normalizeClass, createVNode, resolveDynamicComponent, mergeProps, withCtx, openBlock, createBlock, renderSlot, createCommentVNode, toRef, useSSRContext, useId, resolveComponent, toDisplayString, renderList, createTextVNode, Transition } from "vue";
import { twJoin } from "tailwind-merge";
import { o as o$3, i as i$5, A as A$3, T as T$1, s as s$2, u as u$6, E as E$2, N as N$3, a as o$4, S as S$1, c as useUI, _ as __nuxt_component_1$1, e as input, d as s$4, f as select, g as selectMenu } from "./selectMenu-CAIBtITz.js";
import { t as twMerge, m as mergeConfig, i as appConfig, x as looseToNumber, y as get } from "../server.mjs";
import { ssrRenderVNode, ssrRenderClass, ssrRenderSlot, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderStyle } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { defu } from "P:/group/peersplit-main/peersplit-main/node_modules/defu/dist/defu.mjs";
import { l as l$1, i as i$6, t as t$5, s as s$3, u as useInjectButtonGroup, a as __nuxt_component_1$2 } from "./Button-97Zr3Qqu.js";
import { useVirtualizer } from "@tanstack/vue-virtual";
import { t as t$4, c as c$2, w as w$4, h, i as i$4, f as f$3, O, u as u$7, S, P, N as N$4 } from "./hidden-CTntKjAB.js";
...
function e$1(i2 = {}, s2 = null, t2 = []) {
  for (let [r2, n2] of Object.entries(i2)) o$1(t2, f$1(s2, r2), n2);
  return t2;
}
function f$1(i2, s2) {
  return i2 ? i2 + "[" + s2 + "]" : s2;
...
function o$1(i2, s2, t2) {
  if (Array.isArray(t2)) for (let [r2, n2] of t2.entries()) o$1(i2, f$1(s2, r2.toString()), n2);
...
let ie = /* @__PURE__ */ Symbol("VirtualContext"), Ae$1 = defineComponent({ name: "VirtualProvider", setup(a2, { slots: h2 }) {
  ...
  function w2(t2 = (n2) => n2) {
    let n2 = d2.value !== null ? v.value[d2.value] : null, s2 = t2(v.value.slice()), b = s2.length > 0 && s2[0].dataRef.order.value !== null ? s2.sort((C, A2) => C.dataRef.order.value - A2.dataRef.order.value) : O(s2, (C) => o$3(C.dataRef.domRef)), O$1 = n2 ? b.indexOf(n2) : null;
    return O$1 === -1 && (O$1 = null), { options: b, activeOptionIndex: O$1 };
  }
  let M2 = computed(() => a2.multiple ? 1 : 0), $2 = computed(() => a2.nullable), [B2, p2] = d$3(computed(() => a2.modelValue), (t2) => y2("update:modelValue", t2), computed(() => a2.defaultValue)), R2 = computed(() => B2.value === void 0 ? u$6(M2.value, { [1]: [], [0]: void 0 }) : B2.value), V = null, i2 = null;
  function I(t2) {
    return u$6(M2.value, { [0]() {
  ...
  let l2 = { comboboxState: o2, value: R2, mode: M2, compare(t2, n2) {
    ...
    d2.value === null && l2.isSelected(n2.value.value) && (b.activeOptionIndex = b.options.indexOf(s2)), v.value = b.options, d2.value = b.activeOptionIndex, D.value = 2, b.options.some((O2) => !o$3(O2.dataRef.domRef)) && (i2 = requestAnimationFrame(() => {
      let O2 = w2();
    ...
    return u$6(M2.value, { [0]: () => l2.compare(toRaw(l2.value.value), toRaw(t2)), [1]: () => toRaw(l2.value.value).some((n2) => l2.compare(toRaw(n2), toRaw(t2))) });
  }, isActive(t2) {
    return d2.value === l2.calculateIndex(t2);
  } };
  w$2([e2, c2, f2], () => l2.closeCombobox(), computed(() => o2.value === 0)), provide(ne, l2), t$5(computed(() => u$6(o2.value, { [0]: i$6.Open, [1]: i$6.Closed })));
  computed(() => {
    var t2;
  ...
  return () => {
    ...
    return h$1(Fragment, [...t2 != null && R2.value != null ? e$1({ [t2]: R2.value }).map(([q2, ue2]) => h$1(f$3, E$2({ features: u$7.Hidden, key: q2, as: "input", type: "hidden", hidden: true, readOnly: true, form: s2, disabled: n2, name: q2, value: ue2 }))) : [], A$3({ theirProps: { ...r2, ...T$1(b, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: O2, slots: h2, attrs: r2, name: "Combobox" })]);
  };
} });
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a2, { attrs: h2, slots: r2, expose: y2 }) {
  ...
  return () => {
    var E2, w2;
    let v = { open: u2.comboboxState.value === 0, disabled: u2.disabled.value, value: u2.value.value }, { ...d2 } = a2, D = { ref: u2.buttonRef, id: o2, type: f2.value, tabindex: "-1", "aria-haspopup": "listbox", "aria-controls": (E2 = o$3(u2.optionsRef)) == null ? void 0 : E2.id, "aria-expanded": u2.comboboxState.value === 0, "aria-labelledby": u2.labelRef.value ? [(w2 = o$3(u2.labelRef)) == null ? void 0 : w2.id, o2].join(" ") : void 0, disabled: u2.disabled.value === true ? true : void 0, onKeydown: c2, onClick: e2 };
  ...
  computed(() => {
    ...
    return o$3(e2.inputRef) ? typeof a2.displayValue != "undefined" && i2 !== void 0 ? (I = a2.displayValue(i2)) != null ? I : "" : typeof i2 == "string" ? i2 : "" : "";
  });
  let d2 = ref(false);
  function D() {
    d2.value = true;
  ...
  function M2(i2) {
    switch (w2(() => {
      ...
      case o$4.Enter:
        ...
        break;
      case o$4.ArrowDown:
        return i2.preventDefault(), i2.stopPropagation(), u$6(e2.comboboxState.value, { [0]: () => e2.goToOption(c$1.Next), [1]: () => e2.openCombobox() });
      case o$4.ArrowUp:
        return i2.preventDefault(), i2.stopPropagation(), u$6(e2.comboboxState.value, { [0]: () => e2.goToOption(c$1.Previous), [1]: () => {
  ...
  function B2(i2) {
    ...
    if (!((l2 = o$3(e2.optionsRef)) != null && l2.contains(I)) && !((g2 = o$3(e2.buttonRef)) != null && g2.contains(I)) && e2.comboboxState.value === 0) return i2.preventDefault(), e2.mode.value === 0 && (e2.nullable.value && e2.value.value === null ? S2() : e2.activationTrigger.value !== 1 && e2.selectActiveOption()), e2.closeCombobox();
  }
  function p2(i2) {
    var T2, l2, g2;
    let I = (T2 = i2.relatedTarget) != null ? T2 : t$1.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$3(e2.buttonRef)) != null && l2.contains(I) || (g2 = o$3(e2.optionsRef)) != null && g2.contains(I) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$2().nextFrame(() => {
  ...
  return () => {
    ...
    let i2 = { open: e2.comboboxState.value === 0 }, { displayValue: I, onChange: T2, ...l2 } = a2, g2 = { "aria-controls": (t2 = e2.optionsRef.value) == null ? void 0 : t2.id, "aria-expanded": e2.comboboxState.value === 0, "aria-activedescendant": e2.activeOptionIndex.value === null ? void 0 : e2.virtual.value ? (n2 = e2.options.value.find((j) => !e2.virtual.value.disabled(j.dataRef.value) && e2.compare(j.dataRef.value, e2.virtual.value.options[e2.activeOptionIndex.value]))) == null ? void 0 : n2.id : (s2 = e2.options.value[e2.activeOptionIndex.value]) == null ? void 0 : s2.id, "aria-labelledby": (C = (b = o$3(e2.labelRef)) == null ? void 0 : b.id) != null ? C : (O2 = o$3(e2.buttonRef)) == null ? void 0 : O2.id, "aria-autocomplete": "list", id: u2, onCompositionstart: D, onCompositionend: E2, onKeydown: M2, onInput: $2, onFocus: p2, onBlur: B2, role: "combobox", type: (A2 = r2.type) != null ? A2 : "text", tabIndex: 0, ref: e2.inputRef, defaultValue: R2.value, disabled: e2.disabled.value === true ? true : void 0 };
  ...
  let e2 = l$1(), c2 = computed(() => e2 !== null ? (e2.value & i$6.Open) === i$6.Open : o2.comboboxState.value === 0);
  ...
  return () => {
    var D, E2, w2;
    let S2 = { open: o2.comboboxState.value === 0 }, v = { "aria-labelledby": (w2 = (D = o$3(o2.labelRef)) == null ? void 0 : D.id) != null ? w2 : (E2 = o$3(o2.buttonRef)) == null ? void 0 : E2.id, id: u2, ref: o2.optionsRef, role: "listbox", "aria-multiselectable": o2.mode.value === 1 ? true : void 0, onMousedown: f2 }, d2 = T$1(a2, ["hold"]);
    return A$3({ ourProps: v, theirProps: d2, slot: S2, attrs: h2, slots: o2.virtual.value && o2.comboboxState.value === 0 ? { ...r2, default: () => [h$1(Ae$1, {}, r2.default)] } : r2, features: N$3.RenderStrategy | N$3.Static, visible: c2.value, name: "ComboboxOptions" });
  };
  ...
  }), S2 = computed(() => o2.isSelected(a2.value)), v = inject(ie, null);
...
let ue = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: [Object, Function], default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(t2, { attrs: n$12, slots: r2, expose: l2 }) {
  ...
  function H2(u2) {
    ...
    d2 instanceof HTMLElement && d2.dataset.headlessuiFocusGuard !== "true" && (N$2(T2, d2) || (s2.value ? P(o$3(o2), u$6(f2.value, { [d$2.Forwards]: () => N$4.Next, [d$2.Backwards]: () => N$4.Previous }) | N$4.WrapAround, { relativeTo: u2.target }) : u2.target instanceof HTMLElement && S(u2.target)));
  }
  return () => {
    let u2 = {}, T2 = { ref: o2, onKeydown: F, onFocusout: H2 }, { features: d2, initialFocus: w2, containers: Q2, ...O2 } = t2;
    return h$1(Fragment, [Boolean(d2 & 4) && h$1(f$3, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$7.Focusable }), A$3({ ourProps: T2, theirProps: { ...n$12, ...O2 }, slot: u2, attrs: n$12, slots: r2, name: "FocusTrap" }), Boolean(d2 & 4) && h$1(f$3, { as: "button", type: "button", "data-headlessui-focus-guard": true, onFocus: a2, features: u$7.Focusable })]);
  };
} }), { features: A$2 });
function W$1(t2) {
...
function N$1({ defaultContainers: o2 = [], portals: i2, mainTreeNodeRef: H2 } = {}) {
  ...
  return { resolveContainers: u2, contains(n2) {
    ...
    return H2 != null ? null : h$1(f$3, { features: u$7.Hidden, ref: t2 });
  } };
}
...
let A$1 = "DC8F892D-2EBD-447C-A4C8-A03058436FF4", Ye = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: A$1 }, initialFocus: { type: Object, default: null }, id: { type: String, default: null }, role: { type: String, default: "dialog" } }, emits: { close: (t2) => true }, setup(t2, { emit: i2, attrs: l2, slots: p2, expose: s$12 }) {
  ...
  let r2 = false, g2 = computed(() => t2.role === "dialog" || t2.role === "alertdialog" ? t2.role : (r2 || (r2 = true, console.warn(`Invalid role [${g2}] passed to <Dialog />. Only \`dialog\` and and \`alertdialog\` are supported. Using \`dialog\` instead.`)), "dialog")), D = ref(0), S2 = l$1(), R2 = computed(() => t2.open === A$1 && S2 !== null ? (S2.value & i$6.Open) === i$6.Open : t2.open), m2 = ref(null), E$22 = computed(() => i$4(m2));
  ...
  })] }), ee = computed(() => w2.value ? "parent" : "leaf"), U2 = computed(() => S2 !== null ? (S2.value & i$6.Closing) === i$6.Closing : false), te = computed(() => N2 || U2.value ? false : k$1.value), le = computed(() => {
    var e2, a2, d2;
  ...
  E(oe, ae), R$1({ type: "Dialog", enabled: computed(() => c2.value === 0), element: m2, onUpdate: (e2, a2) => {
    if (a2 === "Dialog") return u$6(e2, { [s.Add]: () => D.value += 1, [s.Remove]: () => D.value -= 1 });
  } });
  ...
  E$1((W2 = E$22.value) == null ? void 0 : W2.defaultView, "keydown", (e2) => {
    ie2.value && (e2.defaultPrevented || e2.key === o$4.Escape && (e2.preventDefault(), e2.stopPropagation(), h2.close()));
  });
  ...
  return d$1(E$22, ue$1, (e2) => {
    ...
    return h$1(u$2, { force: true }, () => [h$1($$1, () => h$1(z, { target: m2.value }, () => h$1(u$2, { force: false }, () => h$1(ue, { initialFocus: a2, containers: B2, features: k$1.value ? u$6(ee.value, { parent: ue.features.RestoreFocus, leaf: ue.features.All & ~ue.features.FocusLock }) : ue.features.None }, () => h$1(X, {}, () => A$3({ ourProps: f2, theirProps: { ...d2, ...l2 }, slot: L2, attrs: l2, slots: p2, visible: c2.value === 0, features: N$3.RenderStrategy | N$3.Static, name: "Dialog" })))))), h$1(Z)]);
  };
} });
defineComponent({ name: "DialogOverlay", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: null } }, setup(t2, { attrs: i2, slots: l2 }) {
  ...
  return () => {
    let { ...r2 } = t2;
    return A$3({ ourProps: { id: p2, "aria-hidden": true, onClick: n2 }, theirProps: r2, slot: { open: s2.dialogState.value === 0 }, attrs: i2, slots: l2, name: "DialogOverlay" });
  };
} });
...
function p(a2) {
  ...
  return () => {
    ...
    let u2 = g$1(e2).trim().toLowerCase();
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe$1 }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r2, emit: w2 }) {
  ...
  function u2(t2 = (i2) => i2) {
    let i2 = p2.value !== null ? s2.value[p2.value] : null, l2 = O(t2(s2.value.slice()), (O2) => o$3(O2.dataRef.domRef)), d2 = i2 ? l2.indexOf(i2) : null;
    return d2 === -1 && (d2 = null), { options: l2, activeOptionIndex: d2 };
  }
  let D = computed(() => o2.multiple ? 1 : 0), [y2, L2] = d$3(computed(() => o2.modelValue), (t2) => w2("update:modelValue", t2), computed(() => o2.defaultValue)), M2 = computed(() => y2.value === void 0 ? u$6(D.value, { [1]: [], [0]: void 0 }) : y2.value), k2 = { listboxState: n2, value: M2, mode: D, compare(t2, i2) {
    ...
    o2.disabled || L2(u$6(D.value, { [0]: () => t2, [1]: () => {
  ...
  }, computed(() => n2.value === 0)), provide($, k2), t$5(computed(() => u$6(n2.value, { [0]: i$6.Open, [1]: i$6.Closed })));
  computed(() => {
    var t2;
  ...
  return () => {
    ...
    return h$1(Fragment, [...t2 != null && M2.value != null ? e$1({ [t2]: M2.value }).map(([I, Q2]) => h$1(f$3, E$2({ features: u$7.Hidden, key: I, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, disabled: l2, name: I, value: Q2 }))) : [], A$3({ ourProps: {}, theirProps: { ...r2, ...T$1(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h2, slots: b, attrs: r2, name: "Listbox" })]);
  };
} });
defineComponent({ name: "ListboxLabel", props: { as: { type: [Object, String], default: "label" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r2 }) {
  ...
  function e2() {
    var v;
    (v = o$3(n2.buttonRef)) == null || v.focus({ preventScroll: true });
  }
  return () => {
    let v = { open: n2.listboxState.value === 0, disabled: n2.disabled.value }, { ...s2 } = o2, m2 = { id: w2, ref: n2.labelRef, onClick: e2 };
    return A$3({ ourProps: m2, theirProps: s2, slot: v, attrs: b, slots: r2, name: "ListboxLabel" });
  };
} });
let je = defineComponent({ name: "ListboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o2, { attrs: b, slots: r2, expose: w2 }) {
  ...
  function v(a2) {
    switch (f2.value && clearTimeout(f2.value), a2.key) {
      ...
      case o$4.Enter:
        ...
        break;
      case u$6(e2.orientation.value, { vertical: o$4.ArrowDown, horizontal: o$4.ArrowRight }):
        return a2.preventDefault(), a2.stopPropagation(), e2.goToOption(c$1.Next);
      case u$6(e2.orientation.value, { vertical: o$4.ArrowUp, horizontal: o$4.ArrowLeft }):
  ...
  let s2 = l$1(), m2 = computed(() => s2 !== null ? (s2.value & i$6.Open) === i$6.Open : e2.listboxState.value === 0);
  return () => {
    var y2, L2;
    ...
    return A$3({ ourProps: D, theirProps: u2, slot: a2, attrs: b, slots: r2, features: N$3.RenderStrategy | N$3.Static, visible: m2.value, name: "ListboxOptions" });
  };
  ...
  w2({ el: f2, $el: f2 });
  let v = computed(() => e2.activeOptionIndex.value !== null ? e2.options.value[e2.activeOptionIndex.value].id === n2 : false), s2 = computed(() => u$6(e2.mode.value, { [0]: () => e2.compare(toRaw(e2.value.value), toRaw(o2.value)), [1]: () => toRaw(e2.value.value).some((t2) => e2.compare(toRaw(t2), toRaw(o2.value))) }));
  computed(() => u$6(e2.mode.value, { [1]: () => {
    var i2;
...
function Q(e2) {
  ...
  function h2(n2) {
    ...
    return r2 ? r2.state !== "visible" && (r2.state = "visible") : t2.value.push({ id: n2, state: "visible" }), () => s2(n2, S$1.Unmount);
  }
...
let W = N$3.RenderStrategy, he = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e2, { emit: t2, attrs: a2, slots: s2, expose: h2 }) {
  let n2 = ref(0);
  function r2() {
    n2.value |= i$6.Opening, t2("beforeEnter");
  }
  function l2() {
    n2.value &= ~i$6.Opening, t2("afterEnter");
  }
  function f2() {
    n2.value |= i$6.Closing, t2("beforeLeave");
  }
  function S2() {
    n2.value &= ~i$6.Closing, t2("afterLeave");
  }
  if (!me() && s$3()) return () => h$1(Se, { ...e2, onBeforeEnter: r2, onAfterEnter: l2, onBeforeLeave: f2, onAfterLeave: S2 }, s2);
  let d2 = ref(null), y2 = computed(() => e2.unmount ? S$1.Unmount : S$1.Hidden);
  h2({ el: d2, $el: d2 });
  let { show: v, appear: A2 } = Te(), { register: D, unregister: H2 } = ge(), i2 = ref(v.value ? "visible" : "hidden"), c2 = i$5(), P2 = Q(() => {
  ...
  g(e2.leaveFrom);
  g(e2.leaveTo);
  return provide(N, P2), t$5(computed(() => u$6(i2.value, { ["visible"]: i$6.Open, ["hidden"]: i$6.Closed }) | n2.value)), () => {
  ...
  let h2 = l$1(), n2 = computed(() => e2.show === null && h2 !== null ? (h2.value & i$6.Open) === i$6.Open : e2.show);
  watchEffect(() => {
  ...
  return provide(N, l2), provide(R, S2), () => {
    ...
    return A$3({ ourProps: { ...y2, as: "template" }, theirProps: {}, slot: {}, slots: { ...s2, default: () => [h$1(ce, { onBeforeEnter: () => t2("beforeEnter"), onAfterEnter: () => t2("afterEnter"), onBeforeLeave: () => t2("beforeLeave"), onAfterLeave: () => t2("afterLeave"), ...a2, ...y2, ...d2 }, s2.default)] }, attrs: {}, features: W, visible: r2.value === "visible", name: "Transition" });
  };
} });
const formGroup = {
  wrapper: "",
...
//# sourceMappingURL=Modal-JZzGCXgD.js.map
