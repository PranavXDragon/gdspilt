...
const _routes = [
  {
    name: "app",
    path: "/app",
    component: () => import("./_nuxt/app-CX8dnYZ8.js"),
    children: [
      {
        name: "app-groups",
        path: "groups",
        component: () => import("./_nuxt/groups-DPA4Bo0T.js"),
        children: [
          {
            name: "app-groups-group-group_id",
            path: "group/:group_id?",
            component: () => import("./_nuxt/_group_id_-CoVjIeKT.js")
          }
        ]
      },
      {
      ...
      },
      {
        name: "app-settings",
        path: "settings",
        component: () => import("./_nuxt/settings-By9gcTlt.js")
      },
      {
        name: "app-settlements",
        path: "settlements",
        component: () => import("./_nuxt/settlements-BgARgBI_.js")
      }
    ]
  },
  {
    ...
    component: () => import("./_nuxt/index-B4G09qar.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-DMPXWIV5.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-YLzJO18g.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-qizimAB7.js"));
