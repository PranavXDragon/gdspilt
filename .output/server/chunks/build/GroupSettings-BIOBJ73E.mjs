import { _ as __nuxt_component_7$1, a as __nuxt_component_2$1, b as __nuxt_component_1, c as __nuxt_component_0, u as useFormGroup, e as usePopper, p, f as u$4, i as i$1, w as w$2, g as c$1, h as f$2 } from './Modal-JZzGCXgD.mjs';
import { s as storeToRefs, b as useGroups, h as useGroupID, r as round, j as computeTransaction, o as groupGetBalances, p as groupGetPayments, t as twMerge, i as appConfig, k as importSplitwise, l as importSupabase, m as mergeConfig } from './server.mjs';
import { computed, mergeProps, withCtx, unref, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, ref, isRef, createCommentVNode, useModel, watch, nextTick, mergeModels, Fragment, renderList, defineComponent, toRef, resolveComponent, renderSlot, resolveDynamicComponent, Transition, useId as useId$1, watchEffect, provide, inject, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderStyle, ssrLooseContain, ssrGetDynamicModelProps, ssrRenderAttr, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderVNode } from 'vue/server-renderer';
import { q as defu } from '../_/nitro.mjs';
import { _ as __nuxt_component_1$1, u as useUI, s as s$1, a as arrow, i, o as o$1, A as A$1, N, b as s, c as u, d as o } from './selectMenu-CAIBtITz.mjs';
import { twJoin } from 'tailwind-merge';
import { _ as __nuxt_component_0$1, a as __nuxt_component_1$2, u as useInjectButtonGroup, g as getNuxtLinkProps, l, i as i$2, t } from './Button-97Zr3Qqu.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import moment from 'moment';
import { _ as __nuxt_component_0$2 } from './nuxt-link-By9b6QI-.mjs';
import { w, h, _, v, N as N$1, O as O$1 } from './hidden-CTntKjAB.mjs';
import { nanoid } from 'nanoid';
import { _ as __nuxt_component_2$2 } from './Tabs-CH6Wi0un.mjs';
import { _ as __nuxt_component_2$3, a as __nuxt_component_3$1 } from './Accordion-DjD1tMCY.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: M, attrs: i2 }) {
  ...
  let l2 = { menuState: I, buttonRef: p2, itemsRef: e, items: r, searchQuery: f$1, activeItemIndex: d, activationTrigger: g, closeMenu: () => {
    ...
    let s2 = b(), v2 = f$2(t2 === c$1.Specific ? { focus: c$1.Specific, id: a } : { focus: t2 }, { resolveItems: () => s2.items, resolveActiveIndex: () => s2.activeItemIndex, resolveId: (u2) => u2.id, resolveDisabled: (u2) => u2.dataRef.disabled });
  ...
  return w$2([p2, e], (t2, a) => {
    var n;
    l2.closeMenu(), w(a, h.Loose) || (t2.preventDefault(), (n = o$1(p2)) == null || n.focus());
  ...
  function l2() {
    if (o$12.disabled) return e.goToItem(c$1.Nothing);
  ...
  function n(u2) {
    t2.wasMoved(u2) && (o$12.disabled || f2.value || e.goToItem(c$1.Specific, p$1, 0));
  }
  function s2(u2) {
    t2.wasMoved(u2) && (o$12.disabled || f2.value && e.goToItem(c$1.Nothing));
  }
  return () => {
...
const _sfc_main$d = {
  ...
  setup(__props) {
    ...
    const categoryLabel = computed(() => {
      var _a;
      return ((_a = categoryData.value) == null ? void 0 : _a.label) || "";
    });
    const categoryIcon = computed(
      () => {
        var _a;
        return ((_a = categoryData.value) == null ? void 0 : _a.icon) || "i-heroicons-ellipsis-horizontal";
      }
    );
    const categoryBgStyle = computed(() => {
      var _a;
      const color = ((_a = categoryData.value) == null ? void 0 : _a.color) || "gray";
      return {
      ...
      if (__props.expense.type === "expense") {
        ...
        if (__props.expense.category) {
          _push(ssrRenderComponent(_component_UBadge, {
            color: ((_a = unref(categoryData)) == null ? void 0 : _a.color) || "gray",
            variant: "soft",
            size: "xs"
          }, {
            default: withCtx((_2, _push2, _parent2, _scopeId) => {
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    function fixWidth() {
      nextTick(() => {
        var _a, _b;
        if ((_b = (_a = button.value) == null ? void 0 : _a.$el) == null ? void 0 : _b.offsetWidth) {
    ...
    function fixValue(member) {
      nextTick(() => {
        var _a;
        const fixed = ((_a = model.value[member].match(/\d+(\.\d?\d?)?/)) == null ? void 0 : _a[0]) || "";
...
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    const getCategoryColor = (id) => {
      ...
      return (cat == null ? void 0 : cat.color) || "gray";
    };
    const getCategoryLabel = (id) => {
      const cat = EXPENSE_CATEGORIES.find((c2) => c2.id === id);
      return (cat == null ? void 0 : cat.label) || "Other";
    };
    ...
    const getDefaultExpense = () => {
      ...
      const myID = (_a = useGroups().getGroupByID(groupID)) == null ? void 0 : _a.myID;
      e.payers = myID ? { [myID]: "" } : {};
      return e;
    };
            ...
            _push2(ssrRenderComponent(_component_UFormGroup, null, {
              label: withCtx((_3, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(paid) !== 0) {
                    _push3(`<span class="font-normal color-positive"${_scopeId2}> \xB7 ${ssrInterpolate(unref(paid))}</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    }, " \xB7 " + toDisplayString(unref(paid)), 1)) : createCommentVNode("", true)
                  ];
                }
              }),
              default: withCtx((_3, _push3, _parent3, _scopeId2) => {
              ...
              label: withCtx((_3, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(remaining) !== 0) {
                    _push3(`<span class="font-normal color-negative"${_scopeId2}> \xB7 ${ssrInterpolate(unref(remaining))} remaining</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  if (unref(expense).splitType === 4) {
                    _push3(`<span class="font-normal color-neutral"${_scopeId2}> \xB7 ${ssrInterpolate(unref(split))} total shares</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                } else {
                  return [
                    ...
                    }, " \xB7 " + toDisplayString(unref(remaining)) + " remaining", 1)) : createCommentVNode("", true),
                    unref(expense).splitType === 4 ? (openBlock(), createBlock("span", {
                      key: 1,
                      class: "font-normal color-neutral"
                    }, " \xB7 " + toDisplayString(unref(split)) + " total shares", 1)) : createCommentVNode("", true)
                  ];
                }
              }),
              default: withCtx((_3, _push3, _parent3, _scopeId2) => {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UFormGroup = __nuxt_component_2$1;
      const _component_UAlert = __nuxt_component_2$3;
      const _component_UInput = __nuxt_component_1;
  ...
  setup(__props) {
    const exportCSV = () => {
      ...
      const getPaymentDescription = (transaction) => {
        var _a, _b, _c, _d;
        const from = (_b = members[(_a = Object.keys(transaction.payers)) == null ? void 0 : _a[0]]) == null ? void 0 : _b.name;
        const to = (_d = members[(_c = Object.keys(transaction.splitters)) == null ? void 0 : _c[0]]) == null ? void 0 : _d.name;
        return `${from} paid ${to}`;
      };
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div><span class="font-medium py-1 block">Members</span><!--[-->`);
  ...
  setup(__props) {
    ...
    const payments = computed(() => {
      ...
      for (const payment of payments2) {
        paymentsByUser[_a = payment.from] || (paymentsByUser[_a] = []);
        paymentsByUser[payment.from].push(payment);
        paymentsByUser[_b = payment.to] || (paymentsByUser[_b] = []);
    ...
    const balances = computed(() => {
      ...
      const payments2 = getPaymentsByGroupID.value(groupID);
      for (const payment of payments2) {
        balancesByUser[_a = payment.from] || (balancesByUser[_a] = 0);
        balancesByUser[payment.from] = round(
          balancesByUser[payment.from] - payment.value
        );
        balancesByUser[_b = payment.to] || (balancesByUser[_b] = 0);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const name = ref((_a = useGroups().getGroupByID(groupID)) == null ? void 0 : _a.name), currency = ref((_b = useGroups().getGroupByID(groupID)) == null ? void 0 : _b.currency);
    function updateName() {
    ...
    function copySummary() {
      ...
      const currency2 = (group == null ? void 0 : group.currency) || "\u20B9";
      const members = Object.values((group == null ? void 0 : group.members) || {});
      const transactions = Object.values((group == null ? void 0 : group.transactions) || {});
      const balances = groupGetBalances(group);
      const payments = groupGetPayments(group);
      let text = `\u{1F4CA} ${(group == null ? void 0 : group.name) || "Group"} - Expense Summary
`;
      text += `\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501\u2501

`;
      text += `\u{1F465} Members (${members.length}):
`;
      for (const m of members) {
        const tag = m.id === (group == null ? void 0 : group.myID) ? " (You)" : "";
...
`;
      ...
      text += `\u{1F4B3} ${expenseCount} expense${expenseCount !== 1 ? "s" : ""}`;
...
`;
      ...
      text += `\u{1F4B0} Total spent: ${currency2}${round(totalSpent)}

`;
      if (payments.length > 0) {
        text += `\u{1F4CB} Outstanding Debts:
`;
...
`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UCard = __nuxt_component_7$1;
      const _component_UButton = __nuxt_component_0$1;
      const _component_UTabs = __nuxt_component_2$2;
      const _component_UFormGroup = __nuxt_component_2$1;
      const _component_UInput = __nuxt_component_1;
...
export { EXPENSE_CATEGORIES as E, _sfc_main$f as _, __nuxt_component_7 as a, _sfc_main$c as b, _sfc_main$7 as c, _sfc_main as d };
//# sourceMappingURL=GroupSettings-BIOBJ73E.mjs.map
