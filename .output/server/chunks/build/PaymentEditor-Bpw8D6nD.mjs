...
import { mergeProps, unref, ref, useModel, computed, withCtx, isRef, createVNode, openBlock, createBlock, Fragment, renderList, createTextVNode, toDisplayString, createCommentVNode, mergeModels, nextTick, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList } from 'vue/server-renderer';
import { _ as __nuxt_component_7, a as __nuxt_component_2, b as __nuxt_component_1$1, c as __nuxt_component_0 } from './Modal-CpCVwxs4.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const adding = ref(false), paidBy = ref(((_b = Object.keys(((_a = __props.expenseItem) == null ? void 0 : _a.payers) || {})) == null ? void 0 : _b[0]) || null), paidTo = ref(((_d = Object.keys(((_c = __props.expenseItem) == null ? void 0 : _c.splitters) || {})) == null ? void 0 : _d[0]) || null);
    const paymentDate = ref(
      (((_e = __props.expenseItem) == null ? void 0 : _e.created_at) ? moment.utc(__props.expenseItem.created_at) : moment.utc()).format("YYYY-MM-DD")
    );
    const model = useModel(__props, "modelValue");
    model.value.hello = ((_g = Object.values(((_f = __props.expenseItem) == null ? void 0 : _f.payers) || {})) == null ? void 0 : _g[0]) || "";
    const groupID = useGroupID();
    const members = computed(() => useGroups().getMembersList(groupID));
    function fixValue(member) {
      nextTick(() => {
        var _a2;
        const fixed = ((_a2 = model.value[member].match(/\d+(\.\d?\d?)?/)) == null ? void 0 : _a2[0]) || "";
    ...
    function getPaymentTransaction() {
      var _a2;
      return {
        id: ((_a2 = __props.expenseItem) == null ? void 0 : _a2.id) || nanoid(),
        type: "payment",
...
//# sourceMappingURL=PaymentEditor-Bpw8D6nD.mjs.map
