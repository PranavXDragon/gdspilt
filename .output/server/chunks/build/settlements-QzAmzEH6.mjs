import { c as __nuxt_component_0, d as __nuxt_component_4 } from './Modal-CpCVwxs4.mjs';
import { _ as __nuxt_component_1 } from './selectMenu-DqLlXyUS.mjs';
import { _ as _sfc_main$1, a as _sfc_main$2 } from './PaymentEditor-Bpw8D6nD.mjs';
import { _ as __nuxt_component_0$1 } from './Button-CIOzeTUV.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const settlementHistory = computed(() => {
      ...
      const g = getGroupByID.value(groupID.value);
      if (!g || !g.transactions) return [];
      return Object.values(g.transactions).filter((tx) => tx.type === "payment").sort((a, b) => {
        var _a;
        return ((_a = b.created_at) == null ? void 0 : _a.localeCompare(a.created_at)) || 0;
      });
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="h-full flex flex-col"><div class="px-3 pt-3 pb-1 flex items-center justify-between gap-2"><div class="flex items-center gap-2"><p class="text-lg font-medium">Settlements</p><span class="text-sm text-gray-400">\xB7</span><span class="text-sm text-gray-500 dark:text-gray-400 truncate max-w-[160px]">${ssrInterpolate((_a = group.value) == null ? void 0 : _a.name)}</span></div>`);
        ...
        _push(ssrRenderComponent(_component_USelectMenu, {
          ...
          label: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              _push2(`<span class="truncate"${_scopeId}>${ssrInterpolate(((_a2 = unref(groupsList).find((g) => g.id === groupID.value)) == null ? void 0 : _a2.name) || "Switch")}</span></div>`);
            } else {
              return [
                createVNode("div", { class: "flex items-center gap-1.5 text-xs truncate" }, [
                  ...
                  createVNode("span", { class: "truncate" }, toDisplayString(((_b = unref(groupsList).find((g) => g.id === groupID.value)) == null ? void 0 : _b.name) || "Switch"), 1)
                ])
              ];
            }
          }),
      ...
      if (unref(loading)) {
        ...
        if (settlementHistory.value.length > 0) {
          ...
          ssrRenderList(settlementHistory.value, (tx, index) => {
            ...
            if (tx.description) {
              _push(`<span> \xB7 ${ssrInterpolate(tx.description)}</span>`);
            } else {
              _push(`<!---->`);
            }
...
//# sourceMappingURL=settlements-QzAmzEH6.mjs.map
