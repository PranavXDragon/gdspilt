...
import { _ as __nuxt_component_2 } from './Accordion-9U6bskbT.mjs';
import { _ as _sfc_main$f, b as _sfc_main$c, c as _sfc_main$7, d as _sfc_main$3 } from './GroupSettings-Bs8Sbqhi.mjs';
import { d as __nuxt_component_4, _ as __nuxt_component_7 } from './Modal-CpCVwxs4.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_GroupSettings = _sfc_main$3;
      ...
      if (!unref(loading) && unref(group)) {
        _push(`<div class="flex flex-col gap-2 h-full px-2"><div class="h-12 flex justify-between items-center gap-2"><span class="text-center font-medium text-lg flex-grow">${ssrInterpolate((_a = unref(getGroupByID)(unref(groupID))) == null ? void 0 : _a.name)}</span><div>`);
...
//# sourceMappingURL=_group_id_-35UCCmyk.mjs.map
